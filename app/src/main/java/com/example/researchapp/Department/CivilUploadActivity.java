...
public class CivilUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_upload);
    ...
    private void uploadPDFFIle(Uri data) {
        ...
        StorageReference reference = storageReference.child("civiluploads/"+System.currentTimeMillis()+".pdf");
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(CivilUploadActivity.this,"File Uploaded Successfully",Toast.LENGTH_SHORT).show();
